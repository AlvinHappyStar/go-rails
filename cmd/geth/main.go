...
import (
	"fmt"
	"github.com/ethereum/go-ethereum/rails"
	"os"
	"sort"
	"strconv"
	"strings"
...
var (
	...
	clientIdentifier = rails.Strings.Client.Name // grails
)
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, rails.Strings.Client.Usage)
...
func init() {
	...
	app.Copyright = rails.Strings.Client.Copyright
...
`)
	...
	case !ctx.IsSet(utils.NetworkIdFlag.Name):
		log.Info(rails.Strings.Client.InfoNetwork.Mainnet)
	}
...
// grails is the main entry point into the system if no special subcommand is run.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func grails(ctx *cli.Context) error {
