...
func TestConsoleWelcome(t *testing.T) {
	coinbase := "0x61027707ec963d0dab0d174d8651e4b7807382bf"
	...
	geth.SetTemplateFunc("grailsver", func() string { return params.VersionWithCommit("", "") })
	...
	geth.Expect(`
Welcome to the Grails JavaScript console!

instance: Grails/v{{grailsver}}/{{goos}}-{{goarch}}/{{gover}}
coinbase: {{.Etherbase}}
at block: 0 ({{niltime}})
 datadir: {{.Datadir}}
 modules: {{apis}}
...
func TestAttachWelcome(t *testing.T) {
	...
	geth := runMinimalGeth(t, "--miner.etherbase", "0x61027707ec963d0dab0d174d8651e4b7807382bf",
		"--ipcpath", ipc,
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	...
	attach.SetTemplateFunc("grailsver", func() string { return params.VersionWithCommit("", "") })
