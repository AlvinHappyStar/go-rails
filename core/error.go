...
var (
	...
	// ErrTipVeryHigh is a sanity error to avoid huge numbers specified
	// in the tip field.
	ErrTipVeryHigh = errors.New("max priority fee per gas higher than 2^256-1")

	// ErrFeeCapVeryHigh is a sanity error to avoid huge numbers specified
	...
	// ErrUnauthorizedDeveloper is returned if the sender is not authorized to deploy
	// new smart contracts
