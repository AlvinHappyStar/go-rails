...
func (beacon *Beacon) CanDeploy(state consensus.StateReader, addr common.Address) bool {
	powba, isPowba := beacon.ethone.(consensus.PoWbA)
	if isPowba {
		return powba.CanDeploy(state, addr)
	}
	return true
}
