...
var (
	...
	addresses = []common.Address{userAddr1, userAddr2, bankAddr}
	account   = core.GetSimulatedGenesisAccount(addresses)
)
...
func newGenesisSpec() core.Genesis {
	return core.Genesis{
		Config: params.AllEthashProtocolChanges,
		Alloc:  core.GenesisAlloc{bankAddr: {Balance: bankFunds}, ethash.DevelopersAddress: account},
		//Alloc:    core.GenesisAlloc{bankAddr: {Balance: bankFunds}, userAddr1: {Balance: big.NewInt(0)}, userAddr2: {Balance: big.NewInt(0)}},
		GasLimit: 100000000,
